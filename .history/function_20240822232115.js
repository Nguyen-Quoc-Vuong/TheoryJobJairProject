...
// chạy luôn function khi khai báo 
var a = function(name) {
...
function talkTo(name) {
    ...
    return function(message) {
        console.log('Hi ' + name + ' ' + message + ' ' + age);
    }
}

var talkToVuong = talkTo('Vuong');
talkToVuong('How are you?');

// closure: ứng dụng trong việc tạo ra các biến private
